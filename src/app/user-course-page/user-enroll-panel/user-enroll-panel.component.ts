...
@Component({
  selector: 'app-user-enroll-panel',
  templateUrl: './user-enroll-panel.component.html',
  styleUrls: ['./user-enroll-panel.component.css']
})
export class UserEnrollPanelComponent implements OnInit {
